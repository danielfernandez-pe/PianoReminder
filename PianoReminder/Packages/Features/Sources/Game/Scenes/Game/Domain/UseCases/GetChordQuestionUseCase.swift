...
//    func getChordQuestion() -> ChordQuestionDOM {
...
//        }
//        fatalError()
//        var options: [ChordQuestionDOM.Option] = optionsIndices.map {
//            ChordQuestionDOM.Option(value: $0, isAnswer: answerChord == $0)
//        }
//
//        options.shuffle()
//        return ChordQuestionDOM(question: answerChord, chordOptions: options)
//    }
}
